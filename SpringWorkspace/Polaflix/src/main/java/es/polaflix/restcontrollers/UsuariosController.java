...
public class UsuariosController {
	...
	@RequestMapping(value = "usuarios/{usuario}/pendientes/{id}", method = RequestMethod.POST)
	public ResponseEntity<Boolean> addSeriePendientes(@PathVariable(value="usuario") String usuario, @PathVariable(value="id") int id){
		Usuario u = ur.findByAlias(usuario);
